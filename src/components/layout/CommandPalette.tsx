...
const NAV_ITEMS: NavItem[] = [
  ...
  // Trabalho
  { label: "Atendimento", icon: Inbox, path: "/app/atendimento" },
  ...
  { label: "Audit Log", icon: History, path: "/app/audit" },
  { label: "Whiteboards", icon: Network, path: "/app/whiteboards" },
  ...
  { label: "Timesheet", icon: Clock, path: "/app/timesheet" },
  { label: "Mídias", icon: Megaphone, path: "/app/midias" },
  // Social
  { label: "Calendário Social", icon: CalendarIcon, path: "/app/social" },
  { label: "Campanhas", icon: Megaphone, path: "/app/campanhas" },
  { label: "Biblioteca", icon: FolderOpen, path: "/app/biblioteca" },
  { label: "Snippets", icon: FileText, path: "/app/snippets" },
  { label: "Pipeline Social", icon: Workflow, path: "/app/social/pipeline" },
  { label: "Analytics Social", icon: LineChart, path: "/app/social/analytics" },
  { label: "Studio Social", icon: Palette, path: "/app/social/studio" },
  { label: "Intel Social", icon: Brain, path: "/app/social/intel" },
  { label: "Inbox Social", icon: InboxIcon, path: "/app/social/inbox" },
  { label: "Cadência Social", icon: Workflow, path: "/app/social/cadencia" },
  { label: "Creators", icon: Users, path: "/app/social/creators" },
  { label: "Bio Editor", icon: Globe, path: "/app/social/bio" },
  { label: "Boosts", icon: Rocket, path: "/app/social/boosts" },
  ...
  { label: "Forecast", icon: TrendingUp, path: "/app/forecast" },
  ...
  { label: "Benchmarks", icon: BarChart3, path: "/app/benchmarks" },
  ...
  { label: "Developer Hub", icon: Cog, path: "/app/developer" },
  ...
  { label: "Skills", icon: Brain, path: "/app/skills" },
  { label: "Capacity", icon: BarChart3, path: "/app/capacity" },
